package com.example.tfmagazine.security.config;
...
import com.example.tfmagazine.security.JWTAuthorizationFilter;
import com.example.tfmagazine.security.JwtAuthenticationEntryPoint;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity httpSecurity) throws Exception {
		...
		httpSecurity.csrf().disable().exceptionHandling().authenticationEntryPoint(unauthorizedHandler)
			...
			.antMatchers("/auth/**", "/produtos/**", "/categorias/**", "/estados/**", "/clientes", "/auth/forgot", "/login")
